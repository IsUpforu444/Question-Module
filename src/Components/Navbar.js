    ...
    return (
        <nav className="flex justify-between items-center text-[1rem] pr-[20px] pl-[20px] NavbarItems mx-auto">
            <h1 className='justify-start cursor-pointer flex items-center text-2xl font-bold '>
                <img className='mr-[0.5rem] ' src={logo} alt="img" />Question Module
            </h1>
            ...
            <ul className={listitem}>
                ...
                <li className="">
                    <Link to="/">
                        <button className='border-blue-600 rounded-full bg-purple-600 text-white pl-4 pr-4 pt-1 pb-1'>Signup</button>
                    </Link>
                </li>
            </ul>
        </nav>
